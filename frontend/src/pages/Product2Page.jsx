...
import product2Img from "../assets/home-page/product2.png";
        ...
        <div className={`home-page ${isMenuOpen ? "menu-open" : ""}`}>
            ...
            <main className="hero-product">
                ...
                <div className="product-content">
                    ...
                    <img src={product2Img} alt="Cristal bouquet" className="product-main-img" />

                    <div className="product-info">
                        <h2 className="product-h2">Milana (bouquet with garden roses)</h2>
                        ...
                        <div className="product-buy-block">
                            ...
                            <AddToCartWithCounter className="btn-dark" productId={2}   />
