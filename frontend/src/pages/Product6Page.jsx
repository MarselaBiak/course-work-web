...
import product6Img from "../assets/home-page/product6.png";
        ...
        <div className={`home-page ${isMenuOpen ? "menu-open" : ""}`}>
            ...
            <main className="hero-product">
                ...
                <div className="product-content">
                    ...
                    <img src={product6Img} alt="Cristal bouquet" className="product-main-img" />

                    <div className="product-info">
                        <h2 className="product-h2">Bouquet of delicate carnation rose</h2>
                        <p className="product-price">$210.00</p>
                        <p className="shipping-text">Shipping calculated at checkout</p>

                        <div className="product-buy-block">

                            <AddToCartWithCounter className="btn-dark" productId={6}    />
