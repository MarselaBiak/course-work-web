...
import product5Img from "../assets/home-page/product5.png";
        ...
        <div className={`home-page ${isMenuOpen ? "menu-open" : ""}`}>
            ...
            <main className="hero-product">
                ...
                <div className="product-content">
                    ...
                    <img src={product5Img} alt="Cristal bouquet" className="product-main-img" />

                    <div className="product-info">
                        <h2 className="product-h2">Bouquet rose bush odilia</h2>
                        ...
                        <div className="product-buy-block">
                            ...
                            <AddToCartWithCounter className="btn-dark" productId={5}    />
