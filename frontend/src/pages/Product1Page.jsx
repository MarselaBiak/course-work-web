...
import product1Img from "../assets/home-page/product1.png";
        ...
        <div className={`home-page ${isMenuOpen ? "menu-open" : ""}`}>
            ...
            <main className="hero-product">
                ...
                <div className="product-content">
                    ...
                    <img src={product1Img} alt="Cristal bouquet" className="product-main-img" />

                    <div className="product-info">
                        <h2 className="product-h2">Cristal (pink carnations with mix flowers)</h2>
