...
import product4Img from "../assets/home-page/product4.png";
    ...
    `                   <Link to="/search">
            ...
            <main className="hero-product">
                ...
                <div className="product-content">
                    ...
                    <img src={product4Img} alt="Cristal bouquet" className="product-main-img" />

                    <div className="product-info">
                        <h2 className="product-h2">Bouquet Hyacinth pink</h2>
                        ...
                        <div className="product-buy-block">
                            <AddToCartWithCounter className="btn-dark" productId={4}    />
                        </div>
